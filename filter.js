...
var tst1 = filterByValue([{first: 'Elie', last:"Schoppik"}, {first: 'Tim', last:"Garcia", isCatOwner: true}, {first: 'Matt', last:"Lane"},
...
string with all of the vowels (both uppercased and lowercased) removed.
...
new array with all of the odd numbers doubled (HINT - you can use map and fitler to
